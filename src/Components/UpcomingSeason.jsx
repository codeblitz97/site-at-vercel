...
const UpcomingSeason = () => {
  ...
  const getSummer = async () => {
    const api = await fetch(
      `${HomeApi}/meta/anilist/advanced-search?season=SUMMER&&year=2023`,
      { timeout: 10000 }
    );
  ...
  const getFall = async () => {
    const api = await fetch(
      `${HomeApi}/meta/anilist/advanced-search?season=FALL&&year=2023`,
      { timeout: 10000 }
    );
    const response = await api.json();
  ...
  const getSpring = async () => {
    const api = await fetch(
      `${HomeApi}/meta/anilist/advanced-search?season=SPRING&&year=2023`,
      { timeout: 1000 }
    );
    const response = await api.json();
  ...
  const getWinter = async () => {
    const api = await fetch(
      `${HomeApi}/meta/anilist/advanced-search?season=WINTER&&year=2023`,
      { timeout: 1000 }
    );
    const response = await api.json();
